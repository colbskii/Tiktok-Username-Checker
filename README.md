...
<div align="center">
  ...
  Loops through a list of usernames to check if they are available or unavailable. Click <a href="https://github.com/lol-jude/TikTok-Username-Checker/issues">here</a> to report bugs.
...
3. Enter your choice of usernames inside of the `usernames.txt` file, or generate them using the <a href="https://github.com/lol-jude/Tiktok-Username-Checker/blob/main/username_generator.py">username_generator.py</a> script.
